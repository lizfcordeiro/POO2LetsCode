...
public class TabuleiroContra implements ITabuleiro{
    private List<Jogador> jogadores = new ArrayList<>(2);
    private List<CartaDeAtaque[]> decks = new ArrayList<>(2);
    private List<CartaDeAtaque> campoAtaque= new ArrayList<>(35);
    private List<CartaDeAtaque> campoEspecial = new ArrayList<>(2);

    public TabuleiroContra( List<Jogador> jogadores) {
